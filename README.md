...
Dans une seconde partie, le code est programmé de sorte à récupérer les informations correspondantes aux caractéristiques des parfums, à partir du code html du site à scrapper. 
...
Pour chaque information extraite, le fichier est alimenté ; cela grâce au code suivant : 
```
